...
public class EMFStorage extends Observable implements ICommitter {
	...
	public static EMFStorage getInstance() {
		System.out.println("EMFStorage getInstance()");
		System.out.println("INSTANCE = ");
		System.out.println(INSTANCE);
		
		if (INSTANCE == null) {
			System.out.println("Since INSTANCE is null, set INSTANCE = new EMFStorage");
			System.out.println(" ");
	...
	protected EMFStorage() {
		System.out.println("protected EMFStorage");
		...
		//System.out.println(replayBody);
		System.out.println("outwardRecordingBody = ");
		System.out.println(outwardRecordingBody);
		System.out.println("BODY_ELEMENTS_COUNT :");
		System.out.println(BODY_ELEMENTS_COUNT);
		System.out.println("NEEDED_CHANGES :");
		System.out.println(NEEDED_CHANGES);
		System.out.println(" ");
	}
					...
					try {
						...
						for (EObject obj : project.getAllModelElements()) {
							if (obj instanceof Body) {
								...
								System.out.println("Checkpoint - EMFStorage recordingBody from instanceof");
								found = true;
								break;
							}
						}
						if (!found) {
							...
							System.out.println("Checkpoint - EMFStorage recordingBody if not found");
	...
	public Body getRecordingBody() {
		System.out.println("In EMF Storage, Body getRecordingBody, outwardRecordingBody:");
		System.out.println(outwardRecordingBody);
		System.out.println(" ");
